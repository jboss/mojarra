...
/**
 * <p>
 * <strong class="changed_modified_2_0"><span class="changed_modified_2_0_rev_a
 * changed_modified_2_1">UIViewRoot</span></strong> is the UIComponent that represents the root of the UIComponent tree.
 * This component renders markup as the response to Ajax requests. It also serves as the root of the component tree, and
 * as a place to hang per-view {@link PhaseListener}s.
 * </p>
 *
 * <p>
...
public class UIViewRoot extends UIComponentBase implements UniqueIdVendor {
    ...
    private static final Map<String, String> LOCATION_IDENTIFIER_MAP = new HashMap<String, String>(6, 1.0f);
    static {
    ...
    enum PropertyKeys {
         ...
         * </p>
         */
        viewId, locale, lastId, beforePhase, afterPhase, phaseListeners,
    }
    ...
    /**
     * <p>
     * Set and cleared during the lifetime of a lifecycle phase. Has no meaning between phases. If <code>true</code>,
     * the lifecycle processing for the current phase must not take place.
     * </p>
     */
     ...
     * <p>
     * Set and cleared during the lifetime of a lifecycle phase. Has no meaning between phases. If <code>true</code>,
     * the <code>MethodExpression</code> associated with <code>afterPhase</code> will not be invoked nor will any
    ...
    /**
     * <p>
     * Return the render kit identifier of the {@link javax.faces.render.RenderKit} associated with this view. Unless
     * explicitly set, as in {@link javax.faces.application.ViewHandler#createView}, the returned value will be
     * <code>null.</code>
     * </p>
     */
    ...
    /**
     * <p>
     * Set the render kit identifier of the {@link javax.faces.render.RenderKit} associated with this view. This method
     * may be called at any time between the end of <em>Apply Request Values</em> phase of the request processing
     * lifecycle (i.e. when events are being broadcast) and the beginning of the <em>Render Response</em> phase.
     * </p>
     *
     * @param renderKitId
     *            The new {@link javax.faces.render.RenderKit} identifier, or <code>null</code> to disassociate this
     *            view with any specific {@link javax.faces.render.RenderKit} instance
     */
    ...
    /**
     * <p>
     * <span class="changed_modified_2_0 changed_modified_2_0_rev_a">Allow</span> an arbitrary method to be called for
     * the "beforePhase" event as the UIViewRoot runs through its lifecycle. This method will be called for all phases
     ...
     * </p>
     *
     * @param newBeforePhase
     *            the {@link MethodExpression} that will be invoked before this view is rendered.
     * @since 1.2
     */
    ...
    /**
     * <p>
     * <span class="changed_modified_2_0">Allow</span> an arbitrary method to be called for the "afterPhase" event as
     * the UIViewRoot runs through its lifecycle. This method will be called for all phases <span
     * class="changed_modified_2_0">including {@link PhaseId#RESTORE_VIEW}</span>. Unlike a true {@link PhaseListener},
     ...
     *
     * @param newAfterPhase
     *            the {@link MethodExpression} that will be invoked after this view is rendered.
     *
     * @since 1.2
     */
    ...
    /**
     * <p>
     * If the argument <code>toRemove</code> is in the list of {@link PhaseListener}s for this instance, it must be
     * removed.
     * </p>
     * 
     * @param toRemove
     *            the {@link PhaseListener} to remove.
     *
     * @since 1.2
     */
    ...
    /**
     * <p>
     * Add the argument <code>newPhaseListener</code> to the list of {@link PhaseListener}s on this
     * <code>UIViewRoot</code>.
     * </p>
     *
     * @param newPhaseListener
     *            the {@link PhaseListener} to add
     *
     * @since 1.2
     */
    ...
    public List<PhaseListener> getPhaseListeners() {
        ...
        return ((result != null) ? Collections.unmodifiableList(result) : Collections.unmodifiableList(Collections
                .<PhaseListener> emptyList()));

    }

    /**
     * <p class="changed_added_2_0">
     * Add argument <code>component</code>, which is assumed to represent a resource instance, as a resource to this
     ...
     * {@link #addComponentResource(javax.faces.context.FacesContext, javax.faces.component.UIComponent, java.lang.String)}
     * .
     * </p>
     *
     ...
     *            The {@link UIComponent} representing a {@link javax.faces.application.Resource} instance
     *
     * @since 2.0
     */
     ...
     * <code>component</code>. If there is no <code>target</code> attribute, set <code>target</code> to be the default
     ...
     * <li>
     * <p>
     * If the component ID of <code>componentResource</code> matches the the ID of a resource that has allready been
     * added, remove the old resource.
     * </p>
     * </li>
     * 
     * <li>
     ...
     *            The {@link UIComponent} representing a {@link javax.faces.application.Resource} instance
     * @param target
     *            The name of the facet for which the {@link UIComponent} will be added
     *
     * @since 2.0
     */
     ...
     * </p>
     * <ul>
     * <li>Locate the facet for the <code>component</code> by calling <code>getFacet()</code> using <code>target</code>
     * as the argument.</li>
     * 
     * <li>If the facet is not found, create the facet by calling
     * <code>context.getApplication().createComponent().</code> <span class="changed_modified_2_0_rev_a">The argument to
     * this method must refer to a component that extends {@link UIPanel} and overrides the <code>encodeAll()</code>
     * method to take no action. This is necessary to prevent component resources from being inadvertently
     * rendered.</span></li>
     * 
     * <ul>
     * 
     * <li class="changed_modified_2_1">Set the <code>id</code> of the facet to be a string created by prepending the
     * literal string &#8220;<code>javax_faces_location_</code>&#8221; (without the quotes) to the value of the
     * <code>target</code> argument</li>
     * 
     * <li>Add the facet to the facets <code>Map</code> using <code>target</code> as the key</li>
     * </ul>
     * <li>return the children of the facet</li> </ul>
     * 
     * </div>
     *
     * @param target
     ...
     *             if <code>target</code> or <code>context</code> is <code>null</code>
     *
     * @since 2.0
     */
    ...
    /**
     * <p>
     * An array of Lists of events that have been queued for later broadcast, with one List for each lifecycle phase.
     * The list indices match the ordinals of the PhaseId instances. This instance is lazily instantiated. This list is
     ...
     *            {@link FacesContext} for the current request
     * @param phaseId
     *            {@link PhaseId} of the current phase
     * 
     * @since 2.0
     */
    public void broadcastEvents(FacesContext context, PhaseId phaseId) {
        ...
        do {
            ...
            hasMoreAnyPhaseEvents = (null != (eventsForPhaseId = events.get(PhaseId.ANY_PHASE.getOrdinal())))
                    && !eventsForPhaseId.isEmpty();
            // true if we have any more events for the argument phaseId
            hasMoreCurrentPhaseEvents = (null != events.get(phaseId.getOrdinal()))
     ...
     * have a <code>finally</code> block that ensures that no {@link FacesEvent}s remain in the event queue. <a
     * class="changed_deleted_2_0_rev_a" title=
     ...
     * 
     * @param context
     *            the <code>FacesContext</code> for this requets
     * @param state
     *            the opaque state object obtained from the {@link javax.faces.application.StateManager}
     */
    @Override
     ...
     * <div class="changed_added_2_0">
     * <p>
     * Perform partial processing by calling {@link javax.faces.context.PartialViewContext#processPartial} with
     * {@link PhaseId#APPLY_REQUEST_VALUES} if:
     * <ul>
     * <li>{@link javax.faces.context.PartialViewContext#isPartialRequest} returns <code>true</code> and we don't have a
     * request to process all components in the view ({@link javax.faces.context.PartialViewContext#isExecuteAll}
     * returns <code>false</code>)</li>
     * </ul>
     * Perform full processing by calling {@link UIComponentBase#processDecodes} if one of the following conditions are
     * met:
     * <ul>
     * <li> {@link javax.faces.context.PartialViewContext#isPartialRequest} returns <code>true</code> and we have a
     * request to process all components in the view ({@link javax.faces.context.PartialViewContext#isExecuteAll}
     * returns <code>true</code>)</li>
     * <li>{@link javax.faces.context.PartialViewContext#isPartialRequest} returns <code>false</code></li>
     * </ul>
     * </p>
     * </div>
     * <p class="changed_modified_2_0">
     * Override the default {@link UIComponentBase#processDecodes} behavior to broadcast any queued events after the
     * default processing or partial processing has been completed and to clear out any events for later phases if the
     * event processing for this phase caused {@link FacesContext#renderResponse} or
    ...
    /**
     * <p>
     * <span class="changed_added_2_0">Override</span> the default {@link UIComponentBase#encodeBegin} behavior. If
     * {@link #getBeforePhaseListener} returns non-<code>null</code>, invoke it, passing a {@link PhaseEvent} for the
     * {@link PhaseId#RENDER_RESPONSE} phase. If the internal list populated by calls to {@link #addPhaseListener} is
     * non-empty, any listeners in that list must have their {@link PhaseListener#beforePhase} method called, passing
     * the <code>PhaseEvent</code>. Any errors that occur during invocation of any of the the beforePhase listeners must
     * be logged and swallowed. After listeners are invoked call superclass processing.
     * </p>
     */
    @Override
    ...
    /**
     * <p class="changed_added_2_0">
     * If {@link javax.faces.context.PartialViewContext#isAjaxRequest} returns <code>true</code>, perform partial
     * rendering by calling {@link javax.faces.context.PartialViewContext#processPartial} with
     * {@link PhaseId#RENDER_RESPONSE}. If {@link javax.faces.context.PartialViewContext#isAjaxRequest} returns
     * <code>false</code>, delegate to the parent {@link javax.faces.component.UIComponentBase#encodeChildren} method.
     * </p>
     *
     * @since 2.0
     */
    ...
    /**
     * <p class="changed_added_2_0">
     * If {@link #getAfterPhaseListener} returns non-<code>null</code>, invoke it, passing a {@link PhaseEvent} for the
     * {@link PhaseId#RENDER_RESPONSE} phase. Any errors that occur during invocation of the afterPhase listener must be
     * logged and swallowed. If the current view has view parameters, as indicated by a non-empty and non-
     * <code>UnsupportedOperationException</code> throwing return from
     * {@link javax.faces.view.ViewDeclarationLanguage#getViewMetadata(javax.faces.context.FacesContext, String)}, call
    ...
    /**
     * <p class="changed_added_2_0">
     * Call {@link UIComponentBase#getRendersChildren} If {@link javax.faces.context.PartialViewContext#isAjaxRequest}
    ...
    /**
     * <p>
     * Utility method that notifies phaseListeners for the given phaseId. Assumes that either or both the
     * MethodExpression or phaseListeners data structure are non-null.
     * </p>
     *
     * @param context
     *            the context for this request
     * @param phaseId
     *            the {@link PhaseId} of the current phase
     * @param isBefore
     *            , if true, notify beforePhase listeners. Notify afterPhase listeners otherwise.
     */
    private void notifyPhaseListeners(FacesContext context, PhaseId phaseId, boolean isBefore) {
        ...
        boolean hasPhaseMethodExpression = (isBefore && (null != beforePhase))
        ...
        if (phaseListenerIterator != null && !beforeMethodException) {
            while ((isBefore) ? phaseListenerIterator.hasNext() : phaseListenerIterator.hasPrevious()) {
                PhaseListener curListener = ((isBefore) ? phaseListenerIterator.next() : phaseListenerIterator
                        .previous());
                if (phaseId == curListener.getPhaseId() || PhaseId.ANY_PHASE == curListener.getPhaseId()) {
                    try {
                        ...
                        if (LOGGER.isLoggable(Level.SEVERE)) {
                            LOGGER.log(Level.SEVERE, "severe.component.uiviewroot_error_invoking_phaselistener",
     ...
     * returns <code>false</code>)</li>
     * </ul>
     * Perform full processing by calling {@link UIComponentBase#processValidators} if one of the following conditions
     * are met:
     * <ul>
     * <li> {@link javax.faces.context.PartialViewContext#isPartialRequest} returns <code>true</code> and we have a
     * request to process all components in the view ({@link javax.faces.context.PartialViewContext#isExecuteAll}
     ...
     * returns <code>false</code>)</li>
     * </ul>
     * Perform full processing by calling {@link UIComponentBase#processUpdates} if one of the following conditions are
     * met:
     * <ul>
     * <li> {@link javax.faces.context.PartialViewContext#isPartialRequest} returns <code>true</code> and we have a
     * request to process all components in the view ({@link javax.faces.context.PartialViewContext#isExecuteAll}
     ...
     * </div>
     * <p class="changed_modified_2_0">
     * Override the default {@link UIComponentBase} behavior to broadcast any queued events after the default processing
     * or partial processing has been completed and to clear out any events for later phases if the event processing for
     * this phase caused {@link FacesContext#renderResponse} or {@link FacesContext#responseComplete} to be called.
     * </p>
     *
     * @param context
     *            {@link FacesContext} for the request we are processing
    ...
    /**
     * <p>
     * Broadcast any events that have been queued for the <em>Invoke
     * Application</em> phase of the request processing lifecycle and to clear out any events for later phases if the
     * event processing for this phase caused {@link FacesContext#renderResponse} or
     * {@link FacesContext#responseComplete} to be called.
     * </p>
     *
     ...
     * <p/>
     * <p>
     * If we have a <code>locale</code> ivar, return it. If we have a value expression for "locale", get its value. If
     * the value is <code>null</code>, return the result of calling
     * {@link javax.faces.application.ViewHandler#calculateLocale}. If the value is an instance of
     * <code>java.util.Locale</code> return it. If the value is a String, convert it to a <code>java.util.Locale</code>
     * and return it. If there is no value expression for "locale", return the result of calling
     * {@link javax.faces.application.ViewHandler#calculateLocale}.
     * </p>
     *
     ...
     * @param fromIndex
     *            starting index
     * @return starting at <code>fromIndex</code>, the index of the first occurrence of any substring from
     *         <code>set</code> in <code>toSearch</code>, or -1 if no such match is found
     */
    ...
    /**
     * <p class="changed_added_2_0">
     * This implementation simply calls through to {@link #getViewMap(boolean)}, passing <code>true</code> as the
    ...
    /**
     * <p class="changed_added_2_0">
     * Returns a <code>Map</code> that acts as the interface to the data store that is the "view scope", or, if this
     * instance does not have such a <code>Map</code> and the <code>create</code> argument is <code>true</code>, creates
     * one and returns it. This map must be instantiated lazily and cached for return from subsequent calls to this
     * method on this <code>UIViewRoot</code> instance. {@link javax.faces.application.Application#publishEvent} must be
     * called, passing {@link PostConstructViewMapEvent}<code>.class</code> as the first argument and this
     * <code>UIViewRoot</code> instance as the second argument.
     * </p>
     *
     * <p>
     * The returned <code>Map</code> must be implemented such that calling <code>clear()</code> on the <code>Map</code>
     * causes {@link javax.faces.application.Application#publishEvent} to be called, passing
     * {@link PreDestroyViewMapEvent}<code>.class</code> as the first argument and this <code>UIViewRoot</code> instance
     * as the second argument.
     * </p>
     * 
     * <p class="changed_modified_2_0_rev_a">
     * Depending upon application configuration, objects stored in the view map may need to be <code>Serializable</code>
     * . In general, it is a good idea to ensure that any objects stored in the view map are <code>Serializable</code>.
     * </p>
     * 
     * <p>
     * See {@link FacesContext#setViewRoot} for the specification of when the <code>clear()</code> method must be
     * called.
     * </p>
     * <p/>
     * </div>
     *
     * @param create
     *            <code>true</code> to create a new <code>Map</code> for this instance if necessary; <code>false</code>
     *            to return <code>null</code> if there's no current <code>Map</code>.
     *
     * @since 2.0
     */
    public Map<String, Object> getViewMap(boolean create) {
        Map<String, Object> viewMap = (Map<String, Object>) getTransientStateHelper().getTransient(
                "com.sun.faces.application.view.viewMap");
     ...
     *
     * @param systemEvent
     *            the <code>Class</code> of event for which <code>listener</code> must be fired.
     * 
     * @param listener
     *            the implementation of {@link javax.faces.event.SystemEventListener} whose
     *            {@link javax.faces.event.SystemEventListener#processEvent} method must be called when events of type
     *            <code>systemEventClass</code> are fired.
     *
     * @throws <code>NullPointerException</code> if <code>systemEventClass</code> or <code>listener</code> are
     *         <code>null</code>.
     *
     * @since 2.0
     */
    ...
    /**
     * <p class="changed_added_2_0">
     * Return the <code>SystemEventListener</code> instances registered on this <code>UIComponent</code> instance that
     * are interested in events of type <code>eventClass</code>.
     * </p>
     *
     * @param systemEvent
     *            the <code>Class</code> of event for which the listeners must be returned.
     * 
     * @throws NullPointerException
     *             if argument <code>systemEvent</code> is <code>null</code>.
     *
     * @since 2.0
     */
    ...
    public void restoreState(FacesContext context, Object state) {
        ...
        Map<String, Object> viewMaps = (Map<String, Object>) context.getExternalContext().getSessionMap()
                .get(ACTIVE_VIEW_MAPS);

        if (viewMaps != null) {
            synchronized (viewMaps) {
                // NOTE: The Active View Maps is not thread safe and viewMaps.get cannot be called without
                // proper synchronization under risk of corrupting the map. SEE JAVASERVERFACES-3966
    ...
    private static final class ViewMap extends HashMap<String, Object> {
        ...
        public Object put(String key, Object value) {
            ...
            if (value != null && ProjectStage.Development.equals(stage) && !(value instanceof Serializable)) {
                LOGGER.log(Level.WARNING, "warning.component.uiviewroot_non_serializable_attribute_viewmap",
